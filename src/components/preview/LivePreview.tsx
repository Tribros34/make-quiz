...
export const LivePreview = ({ state }: LivePreviewProps) => {
    ...
    return (
        <div className="bg-gray-100 p-4 lg:p-8 overflow-auto h-full flex flex-col items-center gap-8 shadow-inner">
            <div className=" w-fit mx-auto transform-gpu origin-top md:transform-none scale-[0.4] sm:scale-[0.6] md:scale-100 transition-transform">
                {/* Cover Page */}
                {settings.coverPage && (
                    <div
                        className="bg-white text-black shadow-xl flex flex-col items-center justify-center p-16 text-center mb-8"
